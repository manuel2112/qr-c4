                ...
                <nav class="menu d-flex d-sm-block justify-content-center flex-wrap">
					...
					<?php if( $session->get('usuario')['isadminqrsession'] ){ ?>
						...
						<?php if( in_array( $_SERVER['REMOTE_ADDR'], array( '127.0.0.1', '::1' ) ) ){ ?>						
							<a href="<?php echo base_url('mailing')?>" title="MAILING" class="<?php echo $segmento == 'mailing' ? 'active' : '' ;?>"><i class="fa fa-object-group"></i> <span>MAILING</span></a>
						<?php } ?>
                	...
                	<?php if( $session->get('usuario') ){?>
                		...
                		<a href="<?php echo base_url()?>" title="INICIO" class="<?php echo $segmento == '' ? 'active' : '' ;?>"><i class="fa fa-home"></i> <span>INICIO</span></a>
                		
						<a href="<?php echo base_url('empresa')?>" title="MIS DATOS" class="<?php echo $segmento == 'empresa' ? 'active' : '' ;?>"><i class="fas fa-cog"></i> <span>MIS DATOS</span></a>

						<a href="<?php echo base_url('tipospago')?>" title="TIPOS DE PAGO" class="<?php echo $segmento == 'tipospago' ? 'active' : '' ;?>"><i class="fa fa-shopping-cart"></i> <span>TIPOS DE PAGO</span></a>

						<a href="<?php echo base_url('menu')?>" title="MENÚ" class="<?php echo $segmento == 'menu' ? 'active' : '' ;?>"><i class="fas fa-bars"></i> <span>MENÚ</span></a>
						
						<a href="<?php echo base_url('pagos')?>" title="CENTRO DE PAGOS" class="<?php echo $segmento == 'pagos' ? 'active' : '' ;?>"><i class="far fa-credit-card"></i> <span>CENTRO DE PAGOS</span></a>
						
						<a href="<?php echo base_url('contacto')?>" title="CONTACTO" class="<?php echo $segmento == 'contacto' ? 'active' : '' ;?>"><i class="fas fa-envelope"></i> <span>CONTACTO</span></a>
